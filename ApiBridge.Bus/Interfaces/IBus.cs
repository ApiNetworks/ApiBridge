...
namespace ApiBridge.Bus.Interfaces
{
    ...
    public interface IBus
    {
        ...
        /// <param name="metadata">Metadata to sent with the message.</param>
        void PublishAsync<T>(T message, Action<ICommandSent<T>> resultCallBack, IDictionary<string, object> metadata = null);
        ...
        /// <param name="resultCallBack">The callback when the message is complete</param>
        /// <param name="metadata">Metadata to sent with the message.</param>
        void PublishAsync<T>(T message, object state, Action<ICommandSent<T>> resultCallBack, IDictionary<string, object> metadata = null);
